...
class Employee(db.Model):
    ...
    hire_date = db.Column(db.Date)
     ...
     # Reltationship mapping the employee to the related reviews
    ...
    # # Reltationship mapping the employee to the related review
    # reviews = db.relationship('Review')

    # # Relationship mapping the employee to related review
...
class Review(db.Model):
    ...
    # Foriegn key stores the Employee id
    employee_id = db.Column(db.Integer, db.ForeignKey('employees.id'))
